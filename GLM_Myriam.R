...
#Model TAD-------------------------------
TAD<-glm(ASE32.1CuantasPersonasTieneIngresoHogarAD~T137.1QuéElementosTeCnologicosEstabanSuoHogarAD+T137.1.1QuéElementosTeCnologicosEstabanSuoHogarADTelevisor+
